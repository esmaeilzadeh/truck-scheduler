...
Generate or upload an instance, click **Solve**. The dispatcher is the primary path;
enable **Compare all solvers** to also run greedy / ALNS / CP-SAT.
